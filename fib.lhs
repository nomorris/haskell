...
super cool, probably won't help much either, as it would 
come down to many stupidly huge multiplications.

enter matrices of format | a b |  
						 | b c |.  "symmetrics".

| a b |   | d e |   | ad+be bd+ce |
| b c | # | e f | = | bd+ce be+cf |, which
preserves symmetry, as can be demonstrated 
...
| a b |   | 1 1 |   | a+b a |   | a+b a |
| b c | # | 1 0 | = | b+c b | = |  a  b |. We know 
that the symmetry will remain, and a=b+c. The 
property of d=e+f also remains, with each new term
being the sum of the other two. These properties 
remain on repeated iterations, we can conclude 
inductively, and a sequence of sums starting with 
